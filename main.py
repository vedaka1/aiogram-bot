...
async def echo(message: types.Message):
    ...
    try: 
        ...
        await bot.edit_message_text(text = f"{html.quote(response)}", message_id= msg.message_id, chat_id= msg.chat.id)
    except:
        await bot.edit_message_text(text = "\U00002757 <i>Error, please try again later</i>", message_id= msg.message_id, chat_id= msg.chat.id)
        print(traceback.format_exc())   
